...
import logo from '../../img/resourcesRaul/Banner2.png';
import ButtonComponent from "../ui/ButtonComponent";

export default function BeSellerPageRaul() {
return (
    <div >
        <NavBar />
        <section className="relative flex justify-center items-center w-full my-10 px-10">
            ...
            <ButtonComponent text="Registrarse" style="bg-contrast-secondary text-white rounded-full py-4 px-4 w-[30%] left-25 bottom-15 font-quicksand absolute hover:bg-gradient-to-br from-contrast-main via-contrast-secondary to-main transition-all duration-400" />
        </section>
