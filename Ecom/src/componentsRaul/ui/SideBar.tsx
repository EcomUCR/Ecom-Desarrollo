    ...
    return (
        <div className="flex flex-col items-start p-4 font-quicksand">
            ...
            <ul className="space-y-3 w-full">
                <li className={`flex items-center gap-2 cursor-pointer px-3 py-2 rounded-md 
                        ${selected === "profile" ? "bg-contrast-secondary text-white" : ""}`}
                    onClick={() => onSelect("profile")}>
                    <IconUser /><p>Información de la cuenta</p>
                </li>
                <li
                    className={`flex items-center gap-2 cursor-pointer px-3 py-2 rounded-md  
                        ${selected === "transactions" ? "bg-contrast-secondary text-white" : ""}`}
                ...
                {type === "seller" && (
                    <li
                        className={`flex items-center gap-2 cursor-pointer px-3 py-2 rounded-md    
                            ${selected === "products" ? "bg-contrast-secondary text-white" : ""}`}
