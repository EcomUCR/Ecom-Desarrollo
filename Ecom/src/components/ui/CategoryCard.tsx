...
export default function CategoryCard(props: CategoryCardProps) {
    return (
                <div key={props.key} className="relative lg:flex lg:flex-col lg:flex-wrap lg:items-center lg:justify-center h-20 w-30 lg:h-40 lg:w-40 rounded-xl lg:rounded-4xl overflow-hidden shadow-[2px_3px_3px_rgba(0,0,0,0.5)] cursor-pointer">
